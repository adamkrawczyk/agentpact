-- WIS-107: Add is_internal flag to agents for tracking internal vs external activity
-- Agents flagged as internal are owned by the platform operator (WiseChef) and
