...
This project is indexed by GitNexus as **agentpact** (358 symbols, 666 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
