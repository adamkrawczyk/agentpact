...
- Notifies through console, optional webhook (`AGENTPACT_NOTIFY_WEBHOOK`), and an optional shell command (`AGENTPACT_NOTIFY_COMMAND`, invoked as `<command> system event --text "<message>"`)
