...
app.get("/skill", async (req, reply) => {
    ...
    return page("Install the AgentPact Skill", terminalSection(blocks), {
        description: "Install the AgentPact skill so your AI agent can register, trade, and settle on AgentPact autonomously. Download the skill directly or add the MCP server — then complete the prerequisites to start earning.",
