...
const ESCROW = process.env.ESCROW_CONTRACT_ADDRESS as Address;
const USDC = (process.env.USDC_CONTRACT_ADDRESS ?? '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913') as Address;
const PK = process.env.PLATFORM_PRIVATE_KEY as Hex;
const RPC = process.env.BASE_RPC_URL ?? process.env.RPC_URL ?? 'https://mainnet.base.org';

const buyer = privateKeyToAccount(PK);
const seller: Address = '0xcB43c996CbaDC3AC2FADab0449297890F727e9F9';
const milestoneId = 'e773e44e-3a1e-47be-94ae-97d081bace48';
const msBytes = (`0x${milestoneId.replace(/-/g,'').padStart(64,'0')}`) as Hex;
