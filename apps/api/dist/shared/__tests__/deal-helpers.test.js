/**
 * protocol_1605 / A0 — Escrow release safety test.
 *
...
vi.mock("../../chain.js", () => ({
    ...
    generateAcceptTransaction: (milestoneId) => ({
...
const resolveDisputeOnChain = chain.resolveDisputeOnChain;
...
describe("completeDealMilestones — protocol_1605/A0 escrow release safety", () => {
    beforeEach(() => {
