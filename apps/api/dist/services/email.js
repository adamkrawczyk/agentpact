 ...
 * levels_2505: Email helper for audit report delivery.
 *
...
const GWS_BIN = process.env.GWS_BIN ?? "/home/adam/.npm-global/bin/gws";
/** Send via gws CLI */
async function sendViaGws(opts) {
...
function tryParseMessageId(stdout) {
    try {
 ...
 */
export function buildAuditEmailBody(contractAddress, reportMd) {
